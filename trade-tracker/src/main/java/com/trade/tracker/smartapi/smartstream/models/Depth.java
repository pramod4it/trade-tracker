...
import static com.trade.tracker.smartapi.utils.Constants.*;
...
public class Depth {
	...
	public BestTwentyData[] getBestTwentyBuyData() {
		return bestTwentyBuyData;
	}


	public void setBestTwentyBuyData(BestTwentyData[] bestTwentyBuyData) {
		this.bestTwentyBuyData = bestTwentyBuyData;
	}


	public BestTwentyData[] getBestTwentySellData() {
		return bestTwentySellData;
	}


	public void setBestTwentySellData(BestTwentyData[] bestTwentySellData) {
		this.bestTwentySellData = bestTwentySellData;
	}
}
